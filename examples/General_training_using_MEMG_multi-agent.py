...
def parse_args():
    ...
    parser.add_argument('--run_name', type=str, default='MEMG-TEST', help='Name of the run')
    parser.add_argument('--num_episode', type=int, default=999999)
    ...
    parser.add_argument('--is_long_term_eval', type=str2bool, default=False)  # 决定路径
...
if __name__ == '__main__':
    ...
    agent_classs = ['AgentMADDPG']
    run_names = ['MEMG_multi_agent_12h-1e-3']
    data_paths = ['concate_year.csv', 'american_data.csv', 'bilishi_data.csv']
    data_paths = ['bilishi_data.csv']
