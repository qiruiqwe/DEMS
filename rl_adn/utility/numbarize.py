...
def pre_power_flow_sam_sequential(active_power, reactive_power, s_base, alpha_Z, alpha_I, Yds, Ydd, nb):
    """
...
def power_flow_sam_sequential(B_inv, C, v_0, s_n, alpha_P, iterations, tolerance, ):
    """
...
def power_flow_sam_sequential_constant_power_only(B_inv, C, v_0, s_n, iterations, tolerance, ):
    """
...
def pre_power_flow_tensor(flag_all_constant_impedance_is_zero, flag_all_constant_current_is_zero,
                          flag_all_constant_powers_are_ones, ts_n, nb, S_nom, alpha_Z, alpha_I, alpha_P, Yds, Ydd):
    """
